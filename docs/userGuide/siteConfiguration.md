...
* **`layout`**: The [layout](userGuide/advancedTopics.html#page-layout) to be used by the page. Default: `default`.
...
**The settings for [auto-deployment to Github pages](userGuide/deployingTheSite.html).**
...
**Specifies that the website should use MarkBind's search functionality.** Default: `true`. See [User Guide: Making the Site Searchable](userGuide/makingTheSiteSearchable.html) for more details.
